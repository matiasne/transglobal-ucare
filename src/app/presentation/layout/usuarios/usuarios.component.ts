...
export class UsuariosComponent extends CrudControllerComponent<ConfigEntity> {
  ...
  public override onSaveDialog(data: ConfigEntity, continueInEdition = false) {
    const diag = this.dialog.open(AlertComponent, { data: { titulo: "Guardar", label: "¿Está seguro de querer guardar este usuario?", type: "question" }, panelClass: ['mo-alert'], autoFocus: false });
