...
{
    [TestClass()]
    public class NuevaComunicacionEventHandlerTests
    {
  ...
  ""client_x509_cert_url"": ""https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-vl9ve%40tgt-geminus-test.iam.gserviceaccount.com""
        ...
        public async Task OnTest()
        {
            ...
            var evento = new NuevaComunicacionEvent(send, send,"Unit Test","Mensaje Unit Test");
            var handler = new NuevaComunicacionEventHandler();
