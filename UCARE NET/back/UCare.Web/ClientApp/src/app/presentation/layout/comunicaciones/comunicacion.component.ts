...
export class ComunicacionComponent extends CrudControllerComponent<ComunicacionEntity> {
  ...
  public estadosAfiliado: Array<SelectItem> = [{ id: "T", label: "Todas" }, { id: "A", label: "Activo" }, { id: "D", label: "Inactivo" }, { id: "R", label: "Provisorio" }];
  public estadosComunicacion: Array<SelectItem> = [{ id: "T", label: "Todas" }, { id: "A", label: "Activo" }, { id: "D", label: "Edicion" }];
  public generosTodos: Array<SelectItem> = [{ id: "T", label: "Todas" }, { id: "M", label: "Masculino" }, { id: "F", label: "Femenino" }, { id: "O", label: "Otro" }];
  public enviadosTodos: Array<SelectItem> = [{ id: "T", label: "Todas" }, { id: "true", label: "Enviados" }, { id: "false", label: "No Enviados" }];
    ...
    this.dialog.open(EdicionComunicacionComponent, {
      data: {
        entity: data, totalAfiliados: this.pageAfiliado.recordCount, onAction: async (entity: any) => {
          ...
          if (!result.isError) {
            this.openDialogOk("La operacion se realizo con exito");
            this.onCancel(true);
          }
        }
      },
